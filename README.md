...
**Software Engineer** — Frontend · Mobile · Backend · Data/AI

싱가포르 기반 AI 스타트업의 한국 지사에서 약 5년간 웹·앱 프론트엔드부터 백엔드, 컴퓨터비전 파이프라인까지 풀 사이클로 개발했습니다.
저장소 scaffolding부터 배포·운영까지 제품을 직접 만드는 일을 좋아하고, 요즘은 LLM을 개발 워크플로에 붙이는 데 관심이 많습니다.
...
- [no1joon.github.io](https://no1joon.github.io) — AI · Tech · Science 글 60여 편
- [blog.naver.com/rottensweetpotato](https://blog.naver.com/rottensweetpotato) — IT/AI 기술 블로그

## Contact

- 💼 [linkedin.com/in/hyunjoon-jang](https://linkedin.com/in/hyunjoon-jang)
